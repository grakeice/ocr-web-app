	...
	"data-[invalid=true]:text-destructive group/field flex w-full gap-3",
	{
		variants: {
			orientation: {
				...
				responsive:
					"@md/field-group:*:data-[slot=field-label]:flex-automd/field-group:has-[>[data-slot=field-content]]:items-start flex-col *:w-full @md/field-group:flex-row @md/field-group:items-center @md/field-group:*:w-auto [&>.sr-only]:w-auto @md/field-group:has-[>[data-slot=field-content]]:[&>[role=checkbox],[role=radio]]:mt-px",
			},
		},
		defaultVariants: {
